...
const features = [
  {
    icon: "/images/Industry Icons/indus-1/Ecommerce/customer engagement -1.png",
    text: "Higher customer engagement and retention",
  },
  {
    icon: "/images/Industry Icons/indus-1/Ecommerce/More significant profits -2.png",
    text: "More significant profits with an increased success rate",
  },
  {
    icon: "/images/Industry Icons/indus-1/Ecommerce/Bug-free user experience - 3.png",
    text: "Bug-free user experience",
  },
  {
    icon: "/images/Industry Icons/indus-1/Ecommerce/Optimize performance, - 4.png",
